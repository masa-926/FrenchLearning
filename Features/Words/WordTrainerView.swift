...
struct WordTrainerView: View {
    ...
    var body: some View {
        ...
        .onAppear {
            ...
            vm.alignToSRSIfNeeded() // ← ViewModel の実装を呼ぶ
        }
    }
...
// 以下（WordCard / ActionBar / EmptyState）はそのまま
...
private struct EmptyState: View {
    ...
    var body: some View {
        VStack(spacing: 12) {
            ...
            Button("ランダムで1語へ", action: onRandomPick).buttonStyle(.borderedProminent).padding(.top, 6)
        }
